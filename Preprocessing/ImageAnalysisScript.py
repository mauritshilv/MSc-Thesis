...
#/Users/mauritshilverda/Documents/Studie/MSc/THESIS/python/airbnbscraper/Scraped_Listing_Images/jpgFiles
#args = vars(ap.parse_args())

# Or hardcopy the input and output directory for the args
#args = {
#    "input": "/Users/mauritshilverda/Documents/Studie/MSc/THESIS/python/airbnbscraper/Scraped_Listing_Images/jpgFiles",
#    "output": "/Users/mauritshilverda/Documents/Studie/MSc/THESIS/python/airbnbscraper/Scraped_Listing_Images/jpgFiles"
#}
...
with open('OutputImageAnalysis2.csv', 'w') as csvfile:        
    ...
    # compute the colorfulness metric for the image
        ...
        ML = mean_luminance(image)
        SL = std_luminance(image)
        S = sharpness(greyimage)
        # Write output to a CSV
        filewriter.writerow([imagePath,C,ML,SL,S])  
